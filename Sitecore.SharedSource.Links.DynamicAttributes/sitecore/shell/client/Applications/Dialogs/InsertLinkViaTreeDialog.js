define(["sitecore"], function(Sitecore) {
  var InsertLinkViaTreeDialog = Sitecore.Definitions.App.extend({
    ...
    insertInternalLinkResult: function () {
      ...
      template = '<link text="<%=displayText%>" anchor="<%=anchor%>" linktype="internal" class="<%=styleClass%>" title="<%=alternateText%>" customattributes="<%=customAttributes%>" <%=target%> querystring="<%=queryString%>" id="<%=itemId%>" />',
      targetWindowValue,
      path,
